...
export class Utilities {
    ...
    static copyProperties(source: Object, target: any) {
        for (let key in source) {
            target[key] = source[key];
        }
    }

    static callOrGetValue(object: Object, key: string, ...params) {
        return Utilities.isFunction(object[key]) ? object[key].apply(this, params) : object[key];
    }
